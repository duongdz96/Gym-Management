          ...
          <template v-if="date">
            ...
            <div class="space-y-1">
              <div 
                ...
                :class="session.isRegistered ? 'bg-red-50 text-red-700 border border-red-100' : 'bg-blue-50 text-blue-700 border border-blue-100'"
            ...
            <div v-else class="space-y-4">
              ...
              >
                ...
                <div class="flex flex-col items-center justify-center w-20 rounded-lg font-bold shrink-0"
                  :class="session.isRegistered ? 'bg-red-50 text-red-700' : 'bg-blue-50 text-blue-700'"
                >
                  <span class="text-lg">{{ session.startTime }}</span>
                  <span class="text-xs font-normal" :class="session.isRegistered ? 'text-red-500' : 'text-blue-500'">đến</span>
