  ...
  <div class="min-h-screen bg-gradient-to-br from-emerald-50 via-emerald-50 to-emerald-50 py-8">
    <div class="mx-auto max-w-7xl px-6">
      ...
      <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Tổng quan hoạt động hôm nay - {{ new Date().toLocaleDateString('vi-VN', {
          weekday:
      ...
      <div v-else class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <!-- New Memberships -->
          <div
            class="bg-white/90 backdrop-blur-lg rounded-xl shadow-md p-6 border-l-4 border-emerald-500 hover:shadow-lg transition-all">
            <div class="flex items-center justify-between">
              ...
              <div
                class="w-16 h-16 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-500 flex items-center justify-center">
          ...
          <div
            ...
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-4xl font-bold text-gray-900 mt-2">{{ (todayStats.totalRevenue / 1000000).toFixed(1) }}M
                </p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <!-- View Memberships -->
          <div
            class="bg-white/90 backdrop-blur-lg rounded-2xl shadow-lg p-6 border border-emerald-100 hover:shadow-xl transition-all transform hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
              <div
                class="w-14 h-14 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-500 flex items-center justify-center">
                <Users class="w-7 h-7 text-white" />
              </div>
              <span class="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full text-xs font-semibold">Hoạt
                động</span>
            </div>
            ...
            <RouterLink :to="{ name: 'reception.customer-management' }"
              class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-500 text-white text-sm font-semibold rounded-lg hover:shadow-lg transition-all">
              Xem danh sách →
            </RouterLink>
          </div>
          ...
          <div
            ...
            <RouterLink :to="{ name: 'reception.teachers' }"
              class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-500 text-white text-sm font-semibold rounded-lg hover:shadow-lg transition-all">
              Xem danh sách →
            </RouterLink>
          </div>
          ...
          <div
            ...
            <RouterLink :to="{ name: 'reception.classes' }"
              class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-emerald-500 to-emerald-500 text-white text-sm font-semibold rounded-lg hover:shadow-lg transition-all">
              Xem danh sách →
            </RouterLink>
          </div>
              ...
              <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                  <tr v-for="tx in recentTransactions" :key="tx.id" class="hover:bg-emerald-50 transition-colors">
                    ...
                    <td class="px-4 py-3 text-sm font-semibold text-right text-gray-900">{{ formatCurrency(tx.amount) }}
                    </td>
