    ...
    <div class="mx-auto max-w-7xl px-6">
      ...
      <div v-else class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <!-- New Memberships -->
          <div class="bg-white/90 backdrop-blur-lg rounded-xl shadow-md p-6 border-l-4 border-red-500 hover:shadow-lg transition-all">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-sm text-red-600 mt-2">↗ Đăng ký mới</p>
              </div>
              <div class="w-16 h-16 rounded-full bg-gradient-to-br from-red-500 to-red-500 flex items-center justify-center">
          ...
          <div class="bg-white/90 backdrop-blur-lg rounded-xl shadow-md p-6 border-l-4 border-red-500 hover:shadow-lg transition-all">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-sm text-red-600 mt-2">↗ VNĐ</p>
              </div>
              <div class="w-16 h-16 rounded-full bg-gradient-to-br from-red-500 to-red-500 flex items-center justify-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <!-- View Memberships -->
          <div class="bg-white/90 backdrop-blur-lg rounded-2xl shadow-lg p-6 border border-red-100 hover:shadow-xl transition-all transform hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
              <div class="w-14 h-14 rounded-full bg-gradient-to-br from-red-500 to-red-500 flex items-center justify-center">
                <Users class="w-7 h-7 text-white" />
              </div>
              <span class="px-3 py-1 bg-red-100 text-red-700 rounded-full text-xs font-semibold">Hoạt động</span>
            </div>
          ...
          <div class="bg-white/90 backdrop-blur-lg rounded-2xl shadow-lg p-6 border border-red-100 hover:shadow-xl transition-all transform hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
              ...
              <span class="px-3 py-1 bg-red-100 text-red-700 rounded-full text-xs font-semibold">Nhanh</span>
            </div>
            ...
            <RouterLink to="/add-membership" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-red-500 to-red-500 text-white text-sm font-semibold rounded-lg hover:shadow-lg transition-all">
              Thêm mới →
            </RouterLink>
          </div>
          ...
          <div class="bg-white/90 backdrop-blur-lg rounded-2xl shadow-lg p-6 border border-red-100 hover:shadow-xl transition-all transform hover:-translate-y-1">
            <div class="flex items-center justify-between mb-4">
              ...
              <span class="px-3 py-1 bg-red-100 text-red-700 rounded-full text-xs font-semibold">Sớm</span>
            </div>
            ...
            <RouterLink to="/reception/class-registration" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-red-500 to-red-500 text-white text-sm font-semibold rounded-lg hover:shadow-lg transition-all">
              Đăng ký ngay →
            </RouterLink>
          </div>
        </div>
            ...
            <div v-else class="overflow-x-auto">
              <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                  <tr v-for="tx in recentTransactions" :key="tx.id" class="hover:bg-red-50 transition-colors">
